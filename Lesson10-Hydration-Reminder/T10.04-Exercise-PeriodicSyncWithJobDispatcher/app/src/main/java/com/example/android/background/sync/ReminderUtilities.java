...
public class ReminderUtilities {
    // k (15) Create three constants and one variable:
    ...
    private static final int REMINDER_INTERVAL_SECONDS = (int) (TimeUnit.MINUTES.toSeconds(minutes));
    ...
    synchronized public static void scheduleChargingReminder(final Context context) {
        ...
        Job contraintJob = dispatcher.newJobBuilder()
                ...
                .build();
        dispatcher.schedule(contraintJob);

        sInitialized = true;
    }

    // k (16) Create a synchronized, public static method called scheduleChargingReminder that takes
    ...
    // Checkout https://github.com/firebase/firebase-jobdispatcher-android for an example
        // k (17) If the job has already been initialized, return
        // k (18) Create a new GooglePlayDriver
        // k (19) Create a new FirebaseJobDispatcher with the driver
        // k (20) Use FirebaseJobDispatcher's newJobBuilder method to build a job which:
        ...
        // k (21) Use dispatcher's schedule method to schedule the job
        // k (22) Set sInitialized to true to mark that we're done setting up the job
}
