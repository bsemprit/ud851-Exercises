...
public class ReminderTasks {
    ...
    public static final String ACTION_CHARGING_NOTIFICATION = "chargingNotif";
    ...
    // k (2) Create an additional task for issuing a charging reminder notification.
    ...
    private static void issueChargingNotif(Context context) {
