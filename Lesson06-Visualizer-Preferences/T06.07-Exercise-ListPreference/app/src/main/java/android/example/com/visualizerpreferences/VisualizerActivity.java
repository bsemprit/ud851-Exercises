...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // k (4) Update setupSharedPreferences and onSharedPreferenceChanged to load the color
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setColor(sharedPreferences.getString(getString(R.string.pref_color_red_value), getResources().getString(R.string.pref_color_red_value)));
