...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // k (2) Modify the setupSharedPreferences method and onSharedPreferencesChanged method to
    ...
    private void loadSize(SharedPreferences sharedPreferences) {
        Float minSize = Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_size_key),getResources().getString(R.string.pref_size_default)));
