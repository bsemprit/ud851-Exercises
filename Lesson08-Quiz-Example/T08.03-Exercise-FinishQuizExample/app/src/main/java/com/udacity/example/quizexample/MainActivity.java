...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get the views
        // k (1) You'll probably want more than just the Button
        mButton = (Button) findViewById(R.id.button_next);
        wordTextView = (TextView) findViewById(R.id.text_view_word);
        descriptionTextView = (TextView) findViewById(R.id.text_view_definition);
    ...
    public void nextWord() {
        ...
        // k (3) Go to the next word in the Cursor, show the next word and hide the definition
        ...
        if(mData != null) {
            ...
            descriptionTextView.setText(def);
    ...
    protected void onDestroy() {
        super.onDestroy();
        // k (5) Remember to close your cursor!
        mData.close();
    }
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            // k (2) Initialize anything that you need the cursor for, such as setting up
