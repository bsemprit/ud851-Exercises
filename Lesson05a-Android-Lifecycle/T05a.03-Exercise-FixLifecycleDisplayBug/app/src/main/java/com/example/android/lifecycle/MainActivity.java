...
public class MainActivity extends AppCompatActivity {
    ...
    // k (1) Declare and instantiate a static ArrayList of Strings called mLifecycleCallbacks
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // k (4) Iterate backwards through mLifecycleCallbacks, appending each String and a newline to mLifecycleDisplay
        for( int i = mLifecycleCallbacks.size() - 1; i >= 0; i--) {
            String state = mLifecycleCallbacks.get(i) + "\n";
            mLifecycleDisplay.append(state);
        }

        // k (5) Clear mLifecycleCallbacks after iterating through it
    ...
    protected void onStop() {
        ...
        // k (2) Add the ON_STOP String to the front of mLifecycleCallbacks
    ...
    protected void onDestroy() {
        ...
        // k (3) Add the ON_DESTROY String to the front of mLifecycleCallbacks
