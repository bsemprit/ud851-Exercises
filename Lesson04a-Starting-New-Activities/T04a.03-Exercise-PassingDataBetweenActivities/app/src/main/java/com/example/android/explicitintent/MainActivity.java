    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // k (1) Retrieve the text from the EditText and store it in a variable
                String newdefaultText = mNameEntry.getText().toString();
                ...
                // k (2) Use the putExtra method to put the String from the EditText in the Intent
                startChildActivityIntent.putExtra(Intent.EXTRA_TEXT, newdefaultText);
